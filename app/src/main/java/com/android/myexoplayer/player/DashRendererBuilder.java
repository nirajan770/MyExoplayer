 ...
 *
 * Created by Nirajan on 9/12/2015.
 */
public class DashRendererBuilder implements RendererBuilder {
    ...
    /**
     * Pass through audio formats (encodings) in order of decreasing priority
     */
    private static final int[] PASSTHROUGH_ENCODINGS_PRIORITY =
            new int[] {C.ENCODING_AC3, C.ENCODING_AC3};

    /**
     * Pass through audio codecs corresponding to the encodings in
